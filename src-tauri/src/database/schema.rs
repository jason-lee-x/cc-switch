...
impl Database {
    ...
    pub(crate) fn create_tables_on_conn(conn: &Connection) -> Result<(), AppError> {
        ...
        conn.execute("CREATE TABLE IF NOT EXISTS proxy_config (
            ...
            listen_port INTEGER NOT NULL DEFAULT 15721, enable_https INTEGER NOT NULL DEFAULT 0, enable_logging INTEGER NOT NULL DEFAULT 1,
        ...
        let _ = conn.execute(
            "ALTER TABLE proxy_config ADD COLUMN enable_https INTEGER NOT NULL DEFAULT 0",
            [],
        );
        let _ = conn.execute(
